...
namespace hlab
{
    ...
    public:
            ...
            float& t, float& w0, float& w1)
        {
            ...
            const vec3 normal1 = glm::cross(point - v0, v2 - v0);
            ...
            const float area0 = glm::length(normal0) * 0.5f;
            const float area1 = glm::length(normal1) * 0.5f;
            const float area2 = glm::length(normal2) * 0.5f;
